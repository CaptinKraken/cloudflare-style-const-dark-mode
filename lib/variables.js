...
Object.keys(_light.default).forEach(function (key) {
  Object.defineProperty(colors, key, {
    get: function get() {
      var darkMode = (0, _darkMode.isDarkMode)();
...
var setColorOverride = exports.setColorOverride = function setColorOverride(color, index, value) {
  var colorOverrides = (0, _darkMode.isDarkMode)() ? darkColorOverrides : lightColorOverrides;
  if (value) {
...
var revertColorOverrides = exports.revertColorOverrides = function revertColorOverrides() {
  var colorOverrides = (0, _darkMode.isDarkMode)() ? darkColorOverrides : lightColorOverrides;
  Object.keys(colorOverrides).forEach(function (key) {
    return delete colorOverrides[key];
  });
};
var fontSizes = exports.fontSizes = [10, 12, 14, 16, 20, 24, 32, 48, 64, 80];
var theme = {
  breakpoints: {
    mobile: '218px',
    mobileWide: '487px',
